	...
	for m in months:
		for d in days:
			...
			for obs in data["history"]["observations"]:
				data = {"humid": obs["hum"],"temp": obs["tempi"],"timestamp": {"year":obs["utcdate"]["year"],"mon": obs["utcdate"]["mon"],"mday": obs["utcdate"]["mday"],"hour": obs["utcdate"]["hour"]},"location": {"lat": 37.855451,"long": -122.125955},"wspd": obs["wspdi"]}
